...
public class Teleport : MonoBehaviour, IGvrGazeResponder {
  ...
  public void SetGazedAt(bool gazedAt) {
		...
		if (GetComponent<Renderer>().transform.position == cube2.transform.position) {
			GetComponent<Renderer>().material.color = gazedAt ? Color.blue : Color.red;
		} else if (GetComponent<Renderer>().transform.position == cube1.transform.position) {
			GetComponent<Renderer>().material.color = gazedAt ? Color.green : Color.cyan;
		}
